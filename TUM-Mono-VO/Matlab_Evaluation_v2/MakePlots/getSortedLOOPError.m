function [ allErrorsAlign, allErrorsR, allErrorsS, allErrorsRMSE, allErrorsA, allErrorsE, n ] = getSortedLOOPError( DATASET, ids, DATASET2 )
...
allErrorsAlign = sort(allErrorsAlign);
